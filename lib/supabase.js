...
export const CAT_COLORS = {
  '时事':'#1a56db','移民':'#16a34a','教育':'#0891b2',
  '财经':'#c2410c','科技':'#7c3aed','生活':'#0d9488',
};
...
export async function fetchArticles({ category=null, page=1, sort='latest', limit=20 }) {
  ...
  let query = supabase
    .from('news_articles')
    .select('id,title,summary,category,source_name,tags,created_at,view_count,is_jingwei,title_en,summary_en')
