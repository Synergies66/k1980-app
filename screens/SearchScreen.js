    ...
    <SafeAreaView style={styles.safe}>
      <View style={styles.header}>
        ...
        <View style={styles.searchRow}>
          <TextInput style={styles.input} placeholder="搜索资讯..." value={query} onChangeText={setQuery} onSubmitEditing={search} returnKeyType="search" placeholderTextColor="#9ca3af" />
      ...
      {loading ? (
        ...
        <FlatList
          ...
          renderItem={({item})=><ArticleCard article={item} onPress={()=>navigation.navigate('Article',{id:item.id})} />}
...
const styles = StyleSheet.create({
  ...
  input:{flex:1,height:40,backgroundColor:'#f3f4f6',borderRadius:10,paddingHorizontal:12,fontSize:14,color:'#111'},
  searchBtn:{backgroundColor:'#e11d27',borderRadius:10,paddingHorizontal:16,justifyContent:'center'},
